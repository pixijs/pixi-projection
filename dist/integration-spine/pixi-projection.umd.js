...
/*!
 * pixi-projection - v0.3.12
 * Compiled Tue, 25 Aug 2020 22:17:39 UTC
 *
...
(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@pixi/math'), require('@pixi/core'), require('@pixi/constants'), require('@pixi/utils'), require('@pixi/display'), require('@pixi/sprite'), require('@pixi/text'), require('@pixi/mesh'), require('@pixi/sprite-tiling'), require('@pixi/mesh-extras'), require('@pixi/graphics')) :
    typeof define === 'function' && define.amd ? define(['exports', '@pixi/math', '@pixi/core', '@pixi/constants', '@pixi/utils', '@pixi/display', '@pixi/sprite', '@pixi/text', '@pixi/mesh', '@pixi/sprite-tiling', '@pixi/mesh-extras', '@pixi/graphics'], factory) :
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.pixi_projection = {}, global.PIXI, global.PIXI, global.PIXI, global.PIXI, global.PIXI, global.PIXI, global.PIXI, global.PIXI, global.PIXI, global.PIXI, global.PIXI));
}(this, (function (exports, math, core, constants, utils$1, display, sprite, text, mesh, spriteTiling, meshExtras, graphics) { 'use strict';
    ...
    ***************************************************************************** */
    ...
    var ProjectedTransform = (function (_super) {
        __extends(ProjectedTransform, _super);
    ...
    var LinearProjection = (function (_super) {
        ...
        function LinearProjection() {
            ...
            _this._affine = exports.AFFINE.NONE;
    ...
    var shaderFrag = "varying vec2 vTextureCoord;\nvarying vec4 vColor;\nvarying float vTextureId;\nuniform sampler2D uSamplers[%count%];\n\nvoid main(void){\n    vec4 color;\n    %forloop%\n    gl_FragColor = color * vColor;\n}";
    ...
    var Batch3dGeometry = (function (_super) {
        ...
        function Batch3dGeometry(_static) {
            ...
            _this._buffer = new core.Buffer(null, _static, false);
            _this._indexBuffer = new core.Buffer(null, _static, true);
            _this.addAttribute('aVertexPosition', _this._buffer, 3, false, constants.TYPES.FLOAT)
        ...
        Batch2dPluginFactory.create = function (options) {
            ...
            return (function (_super) {
                ...
                function BatchPlugin(renderer) {
                    ...
                    _this.shaderGenerator = new core.BatchShaderGenerator(vertex, fragment);
                ...
                BatchPlugin.prototype.packInterleavedGeometry = function (element, attributeBuffer, indexBuffer, aIndex, iIndex) {
                    ...
                    var argb = alpha < 1.0 && element._texture.baseTexture.alphaMode ? utils$1.premultiplyTint(element._tintRGB, alpha)
    ...
    var UniformBatchRenderer = (function (_super) {
        ...
        UniformBatchRenderer.prototype.buildDrawCalls = function (texArray, start, finish) {
            ...
            var drawCalls = core.AbstractBatchRenderer._drawCallPool;
            ...
            for (var i = start; i < finish; ++i) {
                ...
                var spriteBlendMode = utils$1.premultiplyBlendMode[tex.alphaMode ? 1 : 0][sprite.blendMode];
    ...
    var p = [new math.Point(), new math.Point(), new math.Point(), new math.Point()];
    var a = [0, 0, 0, 0];
    ...
    var BilinearSurface = (function (_super) {
        ...
        function BilinearSurface() {
            var _this = _super.call(this) || this;
            _this.distortion = new math.Point();
            return _this;
        }
    ...
    var fun = math.Transform.prototype.updateTransform;
    ...
    var Container2s = (function (_super) {
        ...
        function Container2s() {
            var _this = _super.call(this) || this;
            _this.proj = new ProjectionSurface(_this.transform);
            return _this;
        }
    ...
    var utils = {
        getIntersectionFactor: function (p1, p2, p3, p4, out) {
        ...
        getPositionFromQuad: function (p, anchor, out) {
    ...
    var t0 = new math.Point();
    var tt = [new math.Point(), new math.Point(), new math.Point(), new math.Point()];
    var tempRect$1 = new math.Rectangle();
    var tempMat$1 = new Matrix2d();
    var Projection2d = (function (_super) {
        __extends(Projection2d, _super);
        function Projection2d(legacy, enable) {
            var _this = _super.call(this, legacy, enable) || this;
            _this.matrix = new Matrix2d();
        ...
        Projection2d.prototype.mapSprite = function (sprite, quad) {
            ...
            return this.mapQuad(tempRect$1, quad);
        };
        Projection2d.prototype.mapQuad = function (rect, p) {
            ...
            var k1 = 1, k2 = 2, k3 = 3;
            var f = utils.getIntersectionFactor(p[0], p[2], p[1], p[3], t0);
            if (f !== 0) {
                k1 = 1;
                k2 = 3;
                k3 = 2;
            ...
            mat3[7] = p[k2].y;
            mat3[8] = 1;
            this.matrix.setToMult(tempMat$1, this.matrix);
            this._projID++;
        };
    ...
    sprite.Sprite.prototype.convertTo2s = function () {
        if (this.proj)
            return;
    ...
    display.Container.prototype.convertTo2s = function () {
        if (this.proj)
            return;
    ...
    display.Container.prototype.convertSubtreeTo2s = function () {
        this.convertTo2s();
    ...
    var BatchBilineardGeometry = (function (_super) {
        ...
        function BatchBilineardGeometry(_static) {
            ...
            _this.addAttribute('aVertexPosition', _this._buffer, 2, false, constants.TYPES.FLOAT)
                .addAttribute('aTrans1', _this._buffer, 3, false, constants.TYPES.FLOAT)
                .addAttribute('aTrans2', _this._buffer, 3, false, constants.TYPES.FLOAT)
                .addAttribute('aSamplerSize', _this._buffer, 2, false, constants.TYPES.FLOAT)
                .addAttribute('aFrame', _this._buffer, 4, false, constants.TYPES.FLOAT)
                .addAttribute('aColor', _this._buffer, 4, true, constants.TYPES.UNSIGNED_BYTE)
                .addAttribute('aTextureId', _this._buffer, 1, true, constants.TYPES.FLOAT)
                .addIndex(_this._indexBuffer);
            return _this;
    ...
    var Container2d = (function (_super) {
        ...
        Container2d.prototype.toLocal = function (position, from, point, skipUpdate, step) {
            if (step === void 0) { step = exports.TRANSFORM_STEP.ALL; }
            if (from) {
    ...
    var defaultFragmentShader = "varying vec2 vTextureCoord;\nuniform vec4 uColor;\n\nuniform sampler2D uSampler;\n\nvoid main(void)\n{\n    gl_FragColor = texture2D(uSampler, vTextureCoord) * uColor;\n}";
    ...
    var Mesh2d = (function (_super) {
        ...
        Mesh2d.defaultVertexShader = defaultVertexShader;
        Mesh2d.defaultFragmentShader = defaultFragmentShader;
        return Mesh2d;
    }(mesh.Mesh));
    var SimpleMesh2d = (function (_super) {
        __extends(SimpleMesh2d, _super);
        function SimpleMesh2d(texture, vertices, uvs, indices, drawMode) {
            var _this = _super.call(this, new mesh.MeshGeometry(vertices, uvs, indices), new mesh.MeshMaterial(texture, {
    ...
    var TilingSprite2d = !spriteTiling.TilingSprite ? null : (function (_super) {
        ...
        function TilingSprite2d(texture, width, height) {
            ...
            _this.tileProj = new Projection2d(_this.tileTransform);
    ...
    }(spriteTiling.TilingSprite));

    var spriteMaskVert = "attribute vec2 aVertexPosition;\nattribute vec2 aTextureCoord;\n\nuniform mat3 projectionMatrix;\nuniform mat3 otherMatrix;\n\nvarying vec3 vMaskCoord;\nvarying vec2 vTextureCoord;\n\nvoid main(void)\n{\n\tgl_Position = vec4((projectionMatrix * vec3(aVertexPosition, 1.0)).xy, 0.0, 1.0);\n\n\tvTextureCoord = aTextureCoord;\n\tvMaskCoord = otherMatrix * vec3( aTextureCoord, 1.0);\n}";

    var spriteMaskFrag = "varying vec3 vMaskCoord;\nvarying vec2 vTextureCoord;\n\nuniform sampler2D uSampler;\nuniform sampler2D mask;\nuniform float alpha;\nuniform vec4 maskClamp;\n\nvoid main(void)\n{\n    vec2 uv = vMaskCoord.xy / vMaskCoord.z;\n\n    float clip = step(3.5,\n        step(maskClamp.x, uv.x) +\n        step(maskClamp.y, uv.y) +\n        step(uv.x, maskClamp.z) +\n        step(uv.y, maskClamp.w));\n\n    vec4 original = texture2D(uSampler, vTextureCoord);\n    vec4 masky = texture2D(mask, uv);\n\n    original *= (masky.r * masky.a * alpha * clip);\n\n    gl_FragColor = original;\n}";

    var tempMat$2 = new Matrix2d();
    var SpriteMaskFilter2d = (function (_super) {
        ...
        SpriteMaskFilter2d.calculateSpriteMatrix = function (input, mappedMatrix, sprite) {
            ...
            var worldTransform = proj && !proj._affine ? proj.world.copyTo2dOr3d(tempMat$2) : tempMat$2.copyFrom(sprite.transform.worldTransform);
    ...
    sprite.Sprite.prototype.convertTo2d = function () {
        if (this.proj)
            return;
    ...
    display.Container.prototype.convertSubtreeTo2d = function () {
        this.convertTo2d();
        for (var i = 0; i < this.children.length; i++) {
            this.children[i].convertSubtreeTo2d();
        }
    };
    if (meshExtras.SimpleMesh) {
    ...
    var shaderVert$2 = "attribute vec2 aVertexPosition;\nattribute vec2 aTextureCoord;\n\nuniform mat3 projectionMatrix;\nuniform mat3 translationMatrix;\nuniform mat3 uTransform;\n\nvarying vec3 vTextureCoord;\n\nvoid main(void)\n{\n    gl_Position.xyw = projectionMatrix * translationMatrix * vec3(aVertexPosition, 1.0);\n\n    vTextureCoord = uTransform * vec3(aTextureCoord, 1.0);\n}";

    var shaderFrag$2 = "varying vec3 vTextureCoord;\n\nuniform sampler2D uSampler;\nuniform vec4 uColor;\nuniform mat3 uMapCoord;\nuniform vec4 uClampFrame;\nuniform vec2 uClampOffset;\n\nvoid main(void)\n{\n    vec2 coord = mod(vTextureCoord.xy / vTextureCoord.z - uClampOffset, vec2(1.0, 1.0)) + uClampOffset;\n    coord = (uMapCoord * vec3(coord, 1.0)).xy;\n    coord = clamp(coord, uClampFrame.xy, uClampFrame.zw);\n\n    vec4 sample = texture2D(uSampler, coord);\n    gl_FragColor = sample * uColor;\n}";

    var shaderSimpleFrag = "varying vec3 vTextureCoord;\n\nuniform sampler2D uSampler;\nuniform vec4 uColor;\n\nvoid main(void)\n{\n    vec4 sample = texture2D(uSampler, vTextureCoord.xy / vTextureCoord.z);\n    gl_FragColor = sample * uColor;\n}";

    var tempMat$3 = new Matrix2d();
    var TilingSprite2dRenderer = (function (_super) {
        ...
        function TilingSprite2dRenderer(renderer) {
            ...
            _this.shader = core.Shader.from(shaderVert$2, shaderFrag$2, uniforms);
            _this.simpleShader = core.Shader.from(shaderVert$2, shaderSimpleFrag, uniforms);
            return _this;
        }
        TilingSprite2dRenderer.prototype.render = function (ts) {
            ...
            tempMat$3.identity();
            tempMat$3.scale(tex.width, tex.height);
            tempMat$3.prepend(lt);
            tempMat$3.scale(1.0 / ts._width, 1.0 / ts._height);
            tempMat$3.invert();
            if (isSimple) {
                tempMat$3.prepend(uv.mapCoord);
            }
            else {
            ...
            shader.uniforms.uTransform = tempMat$3.toArray(true);
            shader.uniforms.uColor = utils$1.premultiplyTintToRgba(ts.tint, ts.worldAlpha, shader.uniforms.uColor, baseTex.premultiplyAlpha);
            shader.uniforms.translationMatrix = ts.transform.worldTransform.toArray(true);
            shader.uniforms.uSampler = tex;
            renderer.shader.bind(shader, false);
            renderer.geometry.bind(quad, undefined);
            renderer.state.setBlendMode(utils$1.correctBlendMode(ts.blendMode, baseTex.premultiplyAlpha));
    ...
    core.systems.MaskSystem.prototype.pushSpriteMask = function (maskData) {
    ...
    var Projection3d = (function (_super) {
        ...
        function Projection3d(legacy, enable) {
            ...
            _this.position = new ObservablePoint3d(_this.onChange, _this, 0, 0);
            _this.scale = new ObservablePoint3d(_this.onChange, _this, 1, 1);
            _this.euler = new ObservableEuler(_this.onChange, _this, 0, 0, 0);
            _this.pivot = new ObservablePoint3d(_this.onChange, _this, 0, 0);
            _this.local = new Matrix3d();
            _this.world = new Matrix3d();
        ...
        Projection3d.prototype.updateLocalTransform = function (lt) {
            ...
            tempMat$4.setToRotationTranslationScale(euler.quaternion, 0, 0, 0, 1, 1, 1);
            matrix.setToMult(matrix, tempMat$4);
    ...
    var Container3d = (function (_super) {
        ...
        function Container3d() {
            var _this = _super.call(this) || this;
            _this.proj = new Projection3d(_this.transform);
            return _this;
        }
    ...
    var container3dToLocal = Container3d.prototype.toLocal;
    var container3dGetDepth = Container3d.prototype.getDepth;
    var container3dIsFrontFace = Container3d.prototype.isFrontFace;
    ...
    exports.Container2s = Container2s;
    ...
    exports.ProjectedTransform = ProjectedTransform;
    ...
    exports.Spine2d = Spine2d;
    exports.Spine3d = Spine3d;
