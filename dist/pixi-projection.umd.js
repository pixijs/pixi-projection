 ...
 * Compiled Tue, 25 Aug 2020 22:33:54 UTC
 *
...
(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@pixi/math'), require('@pixi/core'), require('@pixi/constants'), require('@pixi/utils'), require('@pixi/display'), require('@pixi/sprite'), require('@pixi/text'), require('@pixi/mesh'), require('@pixi/sprite-tiling'), require('@pixi/mesh-extras')) :
    typeof define === 'function' && define.amd ? define(['exports', '@pixi/math', '@pixi/core', '@pixi/constants', '@pixi/utils', '@pixi/display', '@pixi/sprite', '@pixi/text', '@pixi/mesh', '@pixi/sprite-tiling', '@pixi/mesh-extras'], factory) :
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.pixi_projection = {}, global.PIXI, global.PIXI, global.PIXI, global.PIXI, global.PIXI, global.PIXI, global.PIXI, global.PIXI, global.PIXI, global.PIXI));
}(this, (function (exports, math, core, constants, utils$1, display, sprite, text, mesh, spriteTiling, meshExtras) { 'use strict';
