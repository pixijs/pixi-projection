 ...
 */
import { Transform, Point, Matrix, Rectangle, ObservablePoint } from '@pixi/math';
import { Renderer, Buffer, Geometry, BatchShaderGenerator, AbstractBatchRenderer, TextureMatrix, Program, Filter, QuadUv, Shader, ObjectRenderer, systems } from '@pixi/core';
...
var p = [new Point(), new Point(), new Point(), new Point()];
var a = [0, 0, 0, 0];
...
var fun = Transform.prototype.updateTransform;
...
var Container2d = (function (_super) {
    ...
    Container2d.prototype.toLocal = function (position, from, point, skipUpdate, step) {
        if (step === void 0) { step = TRANSFORM_STEP.ALL; }
        if (from) {
...
var SimpleMesh2d = (function (_super) {
    ...
    function SimpleMesh2d(texture, vertices, uvs, indices, drawMode) {
        var _this = _super.call(this, new MeshGeometry(vertices, uvs, indices), new MeshMaterial(texture, {
...
var TilingSprite2d = !TilingSprite ? null : (function (_super) {
...
var TilingSprite2dRenderer = (function (_super) {
    ...
    function TilingSprite2dRenderer(renderer) {
        ...
        _this.shader = Shader.from(shaderVert$2, shaderFrag$2, uniforms);
        _this.simpleShader = Shader.from(shaderVert$2, shaderSimpleFrag, uniforms);
        return _this;
    }
    TilingSprite2dRenderer.prototype.render = function (ts) {
        ...
        shader.uniforms.uColor = premultiplyTintToRgba(ts.tint, ts.worldAlpha, shader.uniforms.uColor, baseTex.premultiplyAlpha);
...
systems.MaskSystem.prototype.pushSpriteMask = function (maskData) {
...
export { AFFINE, AbstractProjection, BilinearSurface, Camera3d, Container2d, Container2s, Container3d, Euler, LinearProjection, Matrix2d, Matrix3d, Mesh2d, Mesh3d2d, ObservableEuler, ObservablePoint3d, Point3d, ProjectedTransform, Projection2d, Projection3d, ProjectionSurface, SimpleMesh2d, SimpleMesh3d2d, Spine2d, Spine3d, Sprite2d, Sprite2s, Sprite3d, SpriteMaskFilter2d, Surface, TRANSFORM_STEP, Text2d, Text2s, Text3d, TilingSprite2d, container2dToLocal, container2dWorldTransform, container3dGetDepth, container3dIsFrontFace, container3dToLocal, container3dWorldTransform, utils };
